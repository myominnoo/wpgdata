...
when filtering or selecting specific columns:
...
[`peg_data()`](https://myominnoo.github.io/wpgdata/reference/peg_data.md)
accepts plain R expressions in the `filter` argument and translates them
to OData automatically. Raw OData strings are also accepted for advanced
use.
